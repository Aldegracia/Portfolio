                    ...
                    <div className={styles.cardGroup} ref={cardGroup}>
                        <div className={`${styles.card} ${styles.cardV1}`}>
                            <div className={styles.cardInner}>
                                <div className={styles.cardTitle}>Aldrin De Gracia</div>
                                <div className={styles.cardDesc}>Website & Graphic Designer</div>
                                <hr/>
                                <p>I am Aldrin, a frontend developer with over 2 years of professional experience.
                                    Successfully building user-friendly websites. I pay attention
                                    to
                                ...
                                <div>
                                    ...
                                    <span>{commonConfig.personal.city}, {commonConfig.personal.state}, {commonConfig.personal.country}</span>
                                </div>
                                <hr/>
                                <div className={styles.cardSectionTitle}>WORK EXPERIENCE</div>
                                <p>
                                    Web & Graphic Designer | EnfraUSA Solution, Inc. <br/>
                                    Frontend Developer | Frontline Business Solution, Inc. <br/>
                                </p>
                            </div>
                            <figure className={styles.figure}>
                                <Image src="/personal/dp-image.JPG" alt="Yasin Genc" width={150} height={150}/>
                            </figure>
                        </div>
